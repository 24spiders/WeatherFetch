...
def build_url(dataset, date):
    ...
    # For ftp access, you need to change the stream number in the files you download according to the following:
    # 1980-1991: 100, 1992-2000: 200, 2001-2010: 300, 2011-present: 400.
    # In the case that data needs to be re-run with scientific changes, these numbers will be incremented (e.g. 401)
    # You can find the base urls from Earthdata Search
